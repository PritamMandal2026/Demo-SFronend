...
const conceptsRoute: Routes = {
    ...
    '/concepts/asset-management/asset-list': {
        key: 'concepts.assetManagement.asset',
        authority: [ADMIN, USER],
    },
    '/concepts/asset-management/customer-edit/[slug]': {
    ...
    '/concepts/asset-management/customer-create': {
    ...
    '/concepts/asset-management/customer-details/[slug]': {
