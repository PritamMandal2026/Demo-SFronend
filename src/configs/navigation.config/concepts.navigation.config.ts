...
const conceptsNavigationConfig: NavigationTree[] = [
    {
        ...
        subMenu: [
            ...
            {
                key: 'concepts.assetManagement',
                path: '',
                title: 'Asset Management',
                translateKey: 'nav.conceptsAssetManagement.assetManagement',
                icon: 'assetManagement',
                type: NAV_ITEM_TYPE_COLLAPSE,
                authority: [ADMIN, USER],
                meta: {
                    description: {
                        translateKey: 'nav.conceptsAssetManagement.assetManagementDesc',
                        label: 'Manage assets and customers',
                    },
                },
                subMenu: [
                    {
                        key: 'concepts.assetManagement.asset',
                        path: `${CONCEPTS_PREFIX_PATH}/asset-management/asset-list`,
                        title: 'Asset',
                        translateKey: 'nav.conceptsAssetManagement.asset',
                        icon: 'asset',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey: 'nav.conceptsAssetManagement.customerListDesc',
                                label: 'List of all customers/assets',
                            },
                        },
                        subMenu: [],
                    },
                    {
                        key: 'concepts.assetManagement.customerEdit',
                        path: `${CONCEPTS_PREFIX_PATH}/asset-management/customer-edit/1`,
                        title: 'Customer Edit',
                        translateKey: 'nav.conceptsAssetManagement.customerEdit',
                        icon: 'customerEdit',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey: 'nav.conceptsAssetManagement.customerEditDesc',
                                label: 'Edit customer/asset info',
                            },
                        },
                        subMenu: [],
                    },
                    {
                        key: 'concepts.assetManagement.customerCreate',
                        path: `${CONCEPTS_PREFIX_PATH}/asset-management/customer-create`,
                        title: 'Customer Create',
                        translateKey: 'nav.conceptsAssetManagement.customerCreate',
                        icon: 'customerCreate',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey: 'nav.conceptsAssetManagement.customerCreateDesc',
                                label: 'Add a new customer/asset',
                            },
                        },
                        subMenu: [],
                    },
                    {
                        key: 'concepts.assetManagement.customerDetails',
                        path: `${CONCEPTS_PREFIX_PATH}/asset-management/customer-details/1`,
                        title: 'Customer Details',
                        translateKey: 'nav.conceptsAssetManagement.customerDetails',
                        icon: 'customerDetails',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey: 'nav.conceptsAssetManagement.customerDetailsDesc',
                                label: 'Detailed customer/asset info',
                            },
                        },
                        subMenu: [],
                    },
